...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,------------------------------------------------------------------------.    ,--------------------------------------------------------------------------------.
GUI_T(KC_TAB),    KC_Q,    KC_W,    KC_E,    KC_R,         KC_T,      KC_MUTE,           KC_VOLU,         KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,         KC_BSPC,
  //|--------+--------+--------+--------+--------+-------------+-------------|    |-------------+-------------+--------+--------+--------+--------+----------------|
  ...
  //|--------+--------+--------+--------+--------+-------------+-------------|    |-------------+-------------+--------+--------+--------+--------+----------------|
    ...
    //|--------+--------+--------+--------+--------+--------+--------|    |--------+--------+--------+----------+---------+--------+-----------|
        KC_TRNS, MS_WHLL, MS_LEFT, MS_DOWN, MS_RGHT, MS_WHLR, KC_TRNS,      KC_TRNS, KC_LEFT, KC_DOWN,     KC_UP, KC_RIGHT, KC_TRNS,    KC_TRNS,
    //|--------+--------+--------+--------+--------+--------+--------|    |--------+--------+--------+----------+---------+--------+-----------|
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                        KC_TRNS, KC_TRNS,   KC_TRNS,  KC_TRNS, KC_TRNS,    KC_TRNS,
    //|--------+--------+--------+--------+--------+--------+--------|    |--------+--------+--------+----------+---------+--------+-----------|
